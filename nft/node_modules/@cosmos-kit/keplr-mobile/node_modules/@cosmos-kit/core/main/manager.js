...
var WalletManager = /*#__PURE__*/function (_StateBase) {
  ...
  function WalletManager(_chains, _assetLists, wallets, logger) {
    var _this;
    var throwErrors = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var defaultNameService = arguments.length > 5 ? arguments[5] : undefined;
    var walletConnectOptions = arguments.length > 6 ? arguments[6] : undefined;
    var _signerOptions = arguments.length > 7 ? arguments[7] : undefined;
    var endpointOptions = arguments.length > 8 ? arguments[8] : undefined;
    var sessionOptions = arguments.length > 9 ? arguments[9] : undefined;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "throwErrors", void 0);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_reconnect", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
      var _this$logger;
      var walletName, _this$getMainWallet$g;
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return _this.getMainWallet(walletName).connect();
          case 6:
            _context2.next = 8;
            return (_this$getMainWallet$g = _this.getMainWallet(walletName).getChainWalletList(true)[0]) === null || _this$getMainWallet$g === void 0 ? void 0 : _this$getMainWallet$g.connect(true);
          case 8:
          case "end":
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_restoreAccounts", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3() {
      var walletName, accountsStr, mainWallet, accounts;
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (walletName) {
              mainWallet = _this.getMainWallet(walletName);
              mainWallet.activate();
      ...
      return _regenerator["default"].wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.next = 8;
            return Promise.all(_this.mainWallets.map( /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(WalletManager, [{
    ...
    value: function init(chains, assetLists, wallets, walletConnectOptions, signerOptions, endpointOptions) {
      ...
      this.mainWallets = wallets.map(function (wallet) {
        ...
        wallet.throwErrors = _this2.throwErrors;
