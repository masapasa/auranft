...
var ChainWC = /*#__PURE__*/function (_ChainWalletBase) {
  (0, _inherits2["default"])(ChainWC, _ChainWalletBase);
  var _super = _createSuper(ChainWC);
  function ChainWC(walletInfo, chainInfo, WCClient) {
    var _this;
    (0, _classCallCheck2["default"])(this, ChainWC);
    _this = _super.call(this, walletInfo, chainInfo);
  ...
  (0, _createClass2["default"])(ChainWC, [{
    key: "setClientNotExist",
    value: function setClientNotExist() {
      this.setState(_core.State.Error);
