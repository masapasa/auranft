...
import { AnimateBox, ModalContentVariants, ModalVariants, ThemeContext } from '../../index';
export const SimpleConnectModalBaseStyle = theme => ({
  position: 'relative',
  alignSelf: 'center',
  borderRadius: 'xl',
  overflow: 'hidden',
...
export const SimpleConnectModal = ({
  ...
  }, /*#__PURE__*/React.createElement(AnimateBox, {
