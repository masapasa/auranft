...
var ThemeContext = /*#__PURE__*/(0, _react.createContext)({
  theme: _types.Themes.Light,
  setTheme: function setTheme() {}
});
exports.ThemeContext = ThemeContext;
var ThemeProvider = function ThemeProvider(_ref) {
  var children = _ref.children;
  var _useReducer = (0, _react.useReducer)(handleThemeChange, {
      theme: _types.Themes.Light,
    ...
    theme = _useReducer2[0],
    updateTheme = _useReducer2[1];
  (0, _react.useEffect)(function () {
    var currentTheme = localStorage.getItem('cosmology-ui-theme');
