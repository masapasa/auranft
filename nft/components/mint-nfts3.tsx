...
import { aurajs } from 'aurajs'; // Use aurajs instead of stargazejs
...
// Create the client and get the message according to the grant-fee.ts and broadcast.ts files
...
// Create the client and get the message according to the grant-fee.ts file
...
const client = await aurajs.ClientFactory.createRPCQueryClient({
rpcEndpoint:
